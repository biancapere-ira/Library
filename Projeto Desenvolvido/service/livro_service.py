...
class LivroService:
    ...
    def listar(self):
        ...
        try:
            ...
            if len(livros) == 0:
                ...
                for livro in livros:
                    print(f'ID: {livro.id} | Título: {livro.titulo} | Resumo: {livro.resumo} | Ano: {str(livro.ano)} | Páginas: {str(livro.paginas)} | ISBN: {livro.isbn} | Categoria: {livro.categoria} | Autor: {livro.autor.nome}')
    ...
    def adicionar(self):
        ...
        try:
            ...
            listar_categorias = self.__categoria_dao.listar()
            ...
            novo_livro = Livro(id, titulo, resumo, ano, paginas, categoria, editora, autor)
    ...
    def mostrar_por_id(self):
        ...
        try:
            ...
            if (liv == None):
                ...
                print(f'ID: {liv.id} | Título: {liv.titulo} | Resumo: {liv.resumo} | Ano: {str(liv.ano)} | Páginas: {str(liv.paginas)} | ISBN: {liv.isbn} | Categoria: {liv.categoria} | Editora: {liv.editora.nome} | Autor: {liv.autor.nome}')
        except Exception as e:
